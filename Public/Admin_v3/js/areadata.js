...
$(document).on('click', '.area-no-duoxuan', function () {
    appendCity(this, 'duoxuan');
});
...
function svae_City() {
    ...
    if($(dataCityinput).is($('.area-duoxuan'))){
    	//		$("#select-area").val("");
			var str='<tr><td><p style="color: #006DCC;" class="city-detail">'+Cityname+'</p></td><td class="show_h text-center">'+
	            '<input type="text" value="1000" class="form-control" name="default_firstweight" style="width:100px;"></td>'+
	            '<td class="show_h text-center"><input type="text" value="" class="form-control" name="default_firstprice"  style="width:100px;">'+
	            '</td><td class="show_h text-center"><input type="text" value="1000" class="form-control" name="default_secondweight"  style="width:100px;">'+
	            '</td><td class="show_h text-center"><input type="text" value="" class="form-control" name="default_secondprice"  style="width:100px;">'+
	            '</td><td class="show_h"><span class="glyphicon glyphicon-remove"></span></td></tr>';
			
			$("#tbody-areas").append(str)
    }
