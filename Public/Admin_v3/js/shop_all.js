...
$().ready(function(){
	...
	var order_num = getCookie('orderNum').split(',');
...
//	    						btnHtml='<div class="order-btn"><input type="button" value="提醒卖家发货" data-id="'+key+'" class="button button-dark cancel-order"></div></dl>';
    					...
    					if(total_num<shipping_num){
    					    temp_fee = shipping_fee;
    					}
//  					var str1='<p class="goods-sum"><span>共'+total_num+'件商品</span><span>合计:￥'+total_price+'（含运费:￥0.00）</span></p></dd>';
    					var str2='<p class="goods-sum"><span>共'+total_num+'件商品</span><span>合计:￥'+total_price+'（含运费:￥'+ temp_fee +'）</span></p></dd>';
