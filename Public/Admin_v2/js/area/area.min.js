 ...
 */
	...
	var __alldiv = {
		...
		320381:['新沂市', 320300],
		320382:['邳州市', 320300],
		320383:['八段工业园区', 320300],
		320384:['金山桥开发区', 320300],
		320399:['其它区', 320300],
		320400:['常州市', 320000],
		320402:['天宁区', 320400],
		320404:['钟楼区', 320400],
		...
		340181:['巢湖市', 340100],
		340182:['北城新区', 340100],
		340183:['高新技术开发区', 340100],
		340184:['滨湖新区', 340100],
		340185:['新站综合开发试验区', 340100],
		340186:['政务文化新区', 340100],
		340187:['经济技术开发区', 340100],
		340191:['中区', 340100],
		340199:['其它区', 340100],
		340200:['芜湖市', 340000],
		340202:['镜湖区', 340200],
...
function getProvinces(spid,vp) {
	...
	var length = 0;
	sp.options.length = 0;
	sp.options.add(new Option("选择省份", ""));
...
function getCitys(scid, spid,vc) {
	...
	sc.options.add(new Option("选择城市", ""));
	for (var key in __alldiv){
		if(pv == __alldiv[key][1]){
			sc.options.add(new Option(__alldiv[key][0],key));
            $('input[name=province]').val(__alldiv[pv][0]);
			if(key == vc) {
...
function getAreas(said, scid,va) {
	...
	sa.options.add(new Option("选择地区", ""));
	for (var key in __alldiv){
		if(cv == __alldiv[key][1]){
			sa.options.add(new Option(__alldiv[key][0],__alldiv[key][0]));
            $('input[name=city]').val(__alldiv[cv][0]);
			if(key == va) {
