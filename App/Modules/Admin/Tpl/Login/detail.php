...
<head>
 ...
 <meta name="viewport" content="initial-scale=1.0,maximum-scale=1.0,user-scalable=no">
	...
	<link rel='stylesheet' type='text/css' href='http://b.ewm.net.cn/klssc/themes/default/__RESOURCE__/recouse/css/bjdetail.css' />
    <link href="http://b.ewm.net.cn/klssc/themes/default/__RESOURCE__/recouse/css/reset.css" rel="stylesheet" type="text/css" />
	<link href="http://b.ewm.net.cn/klssc/themes/default/__RESOURCE__/recouse/css/bjcommon.css" rel="stylesheet" type="text/css" />
	<script type="text/javascript" src="http://b.ewm.net.cn/klssc/themes/default/__RESOURCE__/recouse/js/jquery-1.7.2.min.js"></script>
	<script src="http://b.ewm.net.cn/klssc/themes/default/__RESOURCE__/recouse/js/jquery.json.js" type="text/javascript"></script>
	<script type="text/javascript" src="http://b.ewm.net.cn/klssc/themes/default/__RESOURCE__/recouse/js/common.js"></script>
	<script type="text/javascript" src="http://b.ewm.net.cn/klssc/themes/default/__RESOURCE__/recouse/js/transport.js"></script>
	<script type="text/javascript" src="http://b.ewm.net.cn/klssc/themes/default/__RESOURCE__/recouse/js/utils.js"></script>
<script type="text/javascript" src="http://b.ewm.net.cn/klssc/themes/default/__RESOURCE__/recouse/js/jquery.lazyload.min.js"></script>
<script type="text/javascript" charset="utf-8">
      $(function() {
          $("img").lazyload({ 
		  placeholder : "http://b.ewm.net.cn/klssc/themes/default/__RESOURCE__/recouse/images/ajax-loader.gif", // 占位图
		threshold : 200, //控制灵敏度
                 effect: "fadeIn"
           });  
      });
...
<div class="product-intro">
	...
	<div id="cont_show">
<script type="text/javascript" src="http://b.ewm.net.cn/klssc/themes/default/__RESOURCE__/recouse/js/jquery.flexslider-min.js"></script>
...
<link href="http://b.ewm.net.cn/klssc/themes/default/__RESOURCE__/recouse/css/flexslider.css" rel="stylesheet" type="text/css" />
<div id="viewport" class="viewport">

<div class="show">
	<div class="slider card card-nomb" style="visibility: visible;">
    <script type="text/javascript" src="http://b.ewm.net.cn/klssc/themes/default/__RESOURCE__/recouse/js/TouchSlide.1.1.js"></script>
    <div id="focus" class="focus">
      ...
      <div class="bd">
       ...
       <?php if(is_array($piclist)) { foreach($piclist as $row) { ?>
        <li><img src="<?php echo WEBSITE_ROOT;?>/attachment/<?php echo $row['attachment'];?>"  /></li>
		<?php } } ?>
        </ul>
      </div>
    </div>
...
<p class="jx-price">价&nbsp;&nbsp;&nbsp;格<strong style=" padding-left:15px" id="marketprice">￥<?php echo $marketprice;?> </strong><?php if($goods['issendfree']==1) { ?><span><img src="http://b.ewm.net.cn/klssc/themes/default/__RESOURCE__/recouse/images/baoyou.png"></span><?php } ?></p>
...
<div class="goods_number clearfix">
	<p class="name">货&nbsp;&nbsp;&nbsp;号</p>
<strong style=" padding-left:15px;color:#BEBEBE" ><?php echo $goods['goodssn'];?></strong>
</div>
<?php } ?>
...
<?php } ?>
<!--<div class="price clearfix">
<p class="jx-price">已&nbsp;&nbsp;&nbsp;售:<strong style=" padding-left:15px;color:#BEBEBE; "><?php echo $goods['sales'];?></strong></p> 
</div>-->
...
<div class="goods_number clearfix">
	...
	<div class="addForm">	
		        ...
		        <input type="button" value="+" class="btn" onClick="chgNum(1);" />
	</div><?php if($goods['istime']!=1&&$stock!=-1) { ?>(库存：<strong  id="goodstotail"><?php echo $stock;?></strong>)<?php } ?>
<!--  -->
</div>
                          ...
                          <?php if(is_array($spec['items'])) { foreach($spec['items'] as $o) { ?>
                                  ...
                                  <?php if(empty($o['thumb'])) { ?>
                                     <span class="property option option_<?php echo $spec['id'];?>" specid='<?php echo $spec['id'];?>' oid="<?php echo $o['id'];?>"  sel='false'><?php echo $o['title'];?></span>
                                        <?php } else { ?>
                                       <span class="propertyimg optionimg option_img_<?php echo $spec['id'];?> " oid="<?php echo $o['id'];?>" specid='<?php echo $spec['id'];?>' sel='false'><img src="<?php echo WEBSITE_ROOT;?>/attachment/<?php echo $_W['attachurl'].$o['thumb']?>" width='50' height='70' /></span>
                                  <?php } ?>
...
<p class="pro-name1"><strong></strong></p>
 ...
 <div class="custom-store">
    ...
    <a class="custom-store-link clearfix" href="<?php echo mobile_url('shopindex')?>">
        <div class="custom-store-img"></div>
        <div class="custom-store-name"><?php echo $cfg['shop_title'];?></div>
...
<div class="pro-detial">
	<div class="pro-intro clearfix">
		<?php $good_content=$goods['content']; $good_content=str_replace("img src=","img src='http://b.ewm.net.cn/klssc/themes/default/__RESOURCE__/recouse/images/ajax-loader.gif' data-original=",$good_content);  echo $good_content;?>
...
<script type="text/javascript" src="http://b.ewm.net.cn/klssc/themes/default/__RESOURCE__/recouse/js/iscroll.js"></script>
<script type="text/javascript">
	var myScroll;
...
<script src="http://b.ewm.net.cn/klssc/themes/default/__RESOURCE__/recouse/js/zepto.min.js" type="text/javascript"></script>
