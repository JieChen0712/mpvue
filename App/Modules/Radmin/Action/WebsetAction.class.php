...
//      }
    ...
    private function get_config(){
        ...
        $webconfig = [
            ...
            //系统配置
            'GROW_MODEL' => C('GROW_MODEL'), //发展模式
            'GROW_MODEL_LEVEL' => C('GROW_MODEL_LEVEL'), //不同级别的发展模式
            ...
            'FUNCTION_MODULE'=> [
                ...
                'SHOP_IN_SHOP' => (int)$FUNCTION_MODULE['SHOP_IN_SHOP'],
            ],
...
//                ordinary_team
            ...
            'MONEY_COUNT_WAY' => C('MONEY_COUNT_WAY'), //统计业绩方式0用虚拟币1订单金额（注明一般情况是这样）
